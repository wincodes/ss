    ...
    if (!empty($username) && !empty($password1) && !empty($password2) && ($password1 == $password2)) {
      ...
      if (mysqli_num_rows($data) == 0) {
        ...
        // Confirm success with the user
          $notification = 'Your account has been successfully created. You\'re now ready to <a href="login.php">log in</a>.';
        } 
		else {
...
<div class="container col-sm-10 col-md-10 col-md-offset-1 col-sm-offset-1">
<?php
...
?>
  ...
  <input type="text" id="username" name="username" maxlength="32" onblur="validateNonEmpty(this, document.getElementById('user_help'))" 
      ...
      <span id="user_help" style="color:#F00" class="help"></span>
     </div>
     ...
     <div class="form-group">
      ...
      <span id="pass1_help" style="color:#F00" class="help"></span>
      </div>
    ...
    <div class="form-group">  
      ...
      <span id="pass2_help" style="color:#F00" class="help"></span>
      </div>
  ...
  <div class="form-group">   
    <label for="firstname">First name:</label>
      ...
      <span id="firstname_help" style="color:#F00" class="help"></span>
      </div>
   ...
   <div class="form-group">
    ...
    <span id="lastname_help" style="color:#F00" class="help"></span>
    </div>
  ...
  <div class="form-group">
      ...
      <span id="date_help" style="color:#F00" class="help"></span>
      <span id="helpBlock" class="help-block">example 1986-08-22</span>
      </div>
  ...
  <div class="form-group">
      ...
      <span id="city_help" style="color:#F00" class="help"></span>
      </div>
  ...
  <div class="form-group">
    <label for="state">State:</label>
      ...
      <span id="state_help" style="color:#F00" class="help"></span>
      </div>
 ...
 <option value="Albania">Albania</option>
  ...
  <option value="Zimbabwe">Zimbabwe</option> 
      ...
      <span id="mail_help" style="color:#F00" class="help"></span>
      </div>

<div class="form-group">
	<label for="fav_sports">Favorite Sports:</label>
      <input type="text" id="fav_sports" name="fav_sports" maxlength="99" value="<?php if (!empty($fav_sports)) echo $fav_sports; ?>"maxlength="100" />
      </div>      
      
       </fieldset>
	<p> By clicking sign up, you agree to sport social <a href="terms.php">terms of use</a></p> 
