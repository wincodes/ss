...
require_once('connectvars.php');
 $dbc = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
  ...
  if (!isset($_SESSION['user_id'])) {
    $notification = 'Please <a href="login.php">log in</a> to access this page.';
    exit();
  }
...
echo'  <form role="form" enctype="multipart/form-data" method="post" action="' . $_SERVER['PHP_SELF'] . '">';
echo '<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo MM_MAXFILESIZE; ?>" />';
echo '<fieldset>';
echo '<legend>Profile Data</legend>';
if (!empty($old_picture)) {
        echo '<img class="profile" src="' . GW_UPLOADPATH . $old_picture . '" class="img-responsive center-block" alt="Profile Picture" /><br />';
      }
