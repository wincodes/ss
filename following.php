...
echo '<h4 class="text-center">Topics you follow: </h4>';
...
echo'<div id="topic1">
<a href="sportforums.php?category='.$row2['category'].'&topic='.$row2['topic_id'].'"><strong>'.$row2['topic'].'</strong>..... by '.$row3['username'].', '.$numrow4.' comments</a> <br /></div>' ;
